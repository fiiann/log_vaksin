...
(function($) {
    ...
    function RecordsCount(obj, settings) {
        ...
        this.create = function() {
            ...
            if (recordsShown < recordsQueryCount && settings.features.paginate) {
                ...
                text += "<span class='dynatable-record-bounds'><b>" + (bounds[0] + 1) + " to " + bounds[1] + "</span> of ";
            } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
                text += recordsShown + " of ";
            }
            text += recordsQueryCount + " " + collection_name;
            if (recordsQueryCount < recordsTotal) {
                text += " (filtered from " + recordsTotal + "total records</b>)";
            }
    ...
    function InputsSearch(obj, settings) {
        ...
        this.create = function() {
            var $search = $('<input class="form-control" placeholder="Cari Data" style="width:250px"/>', {
                    type: 'search',
    ...
    function PaginationPerPage(obj, settings) {
        ...
        this.create = function() {
            var $select = $('<select class="per-pages">', {
            ...
            }).append("<span class='dynatable-per-page-label'><b>" + settings.inputs.perPageText + "</b></span>").append($select);
        };
    ...
    function PaginationLinks(obj, settings) {
        ...
        this.create = function() {
            ...
            pageLinks += '<li><span><b>Halaman : </b></span></li>';
