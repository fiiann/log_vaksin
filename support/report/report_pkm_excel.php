...
<?php
  ...
  $get = "SELECT p.id_pakai
		 ...
		 inner join instansi i 
		  on i.kode_instansi=p.kode_instansi
		 inner join amprahan a 
		  on i.kode_instansi=a.kode_instansi 
		 where p.bulan='$bulan' and p.tahun='$tahun' group by i.kode_instansi";
...
<table>
<tr>
  <td colspan="18" align='center'><h4>Laporan Pemakaian Vaksin Di Puskesmas dalam Kab. Aceh Barat <?php echo $_GET['tahun'];?></h4></td>
</tr>
<tr>
