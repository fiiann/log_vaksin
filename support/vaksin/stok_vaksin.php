		...
		$("#simpanstok").click(function(){
			...
			if ((jenis.length>0) && (jumlah.length>0)) 
			{
				...
				$.ajax({
						type 	: "POST",
						url	 	: "simpan_stok.php",
						data 	: "id_jenis="+jenis+"&bulan="+bulan+"&tahun="+tahun+"&jumlah="+jumlah+'&satuan='+satuan,
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<div>
			<input id="jumlah_stok" name="jumlah_stok" class="element text small" type="text" maxlength="255"/> 
		</div> 
		</li>	
        <li id="li_6" >
		...
		<li class="buttons">
				...
				<input id="simpanstok" class="button_text" type="button" name="simpanstok" value="Simpan Stok" />
		</li>
		<div id="confirm"></div>
			</ul>
		</form>	
