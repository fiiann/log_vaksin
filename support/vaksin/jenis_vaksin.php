...
?>	
	...
	<div id="form_container">
		...
		<form id="form_899286" class="appnitro"  method="post" action="">
			...
			<h2>Input Jenis Vaksin</h2>
			<p>masukan data jenis Vaksin dengan lengkap dan benar</p>
		</div>						
			<ul >
			
		<input id="idjenis" name="idjenis" class="element text small" type="hidden" maxlength="255" value="<?php echo autonumb('jenis_vaksin','id_jenis','2','JN');?>">
		<label class="description" for="element_2">Jenis Vaksin * </label>
		<div>
			<input id="namajenis" name="namajenis" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>
				...
				<input id="simpanjenis" class="button_text" type="button" name="simpanjenis" value="Simpan Data" />
		</li>
		<div id="confirm"></div>	
		</ul>
		</form>	
