...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var tombol		= $('<br><span id="space">&nbsp;&nbsp;</span><input type="button" name="TbSimpan" id="TbSimpan" value="Simpan Order">&nbsp;<input type="button" name="cetakorder" id="cetakorder" value="Cetak Order">');
...
<?php
 ...
 ?>		
		...
		<div id="listview_container">			 	
				...
				<img src="../../images/order-med.png" style="padding:5px"><span id="head" style="font-family:trebuchet ms;font-size:25px;font-weight:bold">Permintaan Vaksin ke Provinsi</span><div id="navcontainer">
		...
		<tr>
			<td><b>&nbsp;ID Order</b></td>
			<td>:  
				  <input type="text" name="newid" id="newid" class="element text small"  value="<?php echo kdauto('trxprov','TProv-')?>" readonly style="border:1px solid">
			</td>						
			<td>&nbsp;</td>
			<td></td>				
		</tr>
