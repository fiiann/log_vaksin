...
<fieldset>
	<legend>Detil Pemakaian Vaksin</legend>
        ...
        <table class="list_vaksin">
            ...
            while ($pk=mysql_fetch_array($qrypakai)){
                ...
                <tr id="list_vaksin_<?php echo $nomor;?>"><td class="jmlv" id="<?php echo $nomor;?>" data-id="<?php echo $id_jenis;?>">
				    ...
				    </select> &nbsp; &nbsp; Pemakaian : <input type="text" class="pakai style-1" id="jml_pakai_<?php echo $id_jenis;?>" data-id="<?php echo $id_jenis;?>" value="<?php echo $jumlah;?>" style="text-align:right" readonly> &nbsp;&nbsp; 
				    Satuan : <input type="text" class="style-1" id="satuan_<?php echo $id_jenis;?>" name="satuan[]" value="<?php echo $satuan;?>" readonly style="text-align:left">
...
<button class='btn btn-success' id='sudah_fix' style='position:absolute;top:123px;left:780px'>Sudah Fix</button>
